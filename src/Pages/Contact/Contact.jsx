        ...
        <div className="flex flex-wrap mb-8 -mx-4">
          <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
            <div className="h-full py-12 text-center transition-all rounded-lg shadow bg-gray-50 hover:shadow-lg">
              <div className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-red-400 rounded-full ">
                <svg
              ...
              <a
                href="#"
                className="text-base font-medium text-gray-400 md:text-lg"
              >
                ITcompany@gmail.com
              </a>
            </div>
          ...
          <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
            <div className="h-full py-12 text-center transition-all rounded-lg shadow  bg-gray-50 hover:shadow-lg">
              <div className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-red-400 rounded-full dark:bg-red-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <form action="">
            ...
            <div className="flex flex-wrap mb-4 -mx-2">
              <div className="w-full px-2 mb-4 lg:mb-0 lg:w-1/2">
                <input
                  className="w-full px-3 py-2 leading-loose border rounded-md"
                  type="text"
            ...
            ></textarea>
            <button className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-red-400 rounded-md hover:bg-red-700">
              Send Message
            </button>
          </form>
        </div>
